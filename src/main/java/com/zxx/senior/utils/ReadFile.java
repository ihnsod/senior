...
public class ReadFile {
    ...
    @Test
    public void testRead() throws InterruptedException, FileNotFoundException {
...
//        readFile();
    ...
    private void readFile() {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader
                (new FileInputStream(new File("C:\\Users\\Aries\\Desktop\\test_insert.txt"))), 1024 * 1024)) {
...
//            downLatch.countD+own();
    ...
    private void readFileChannel() {
        File file = new File("C:\\Users\\Aries\\Desktop\\test_insert.txt");
    ...
    public void test1() {
        ...
        try (BufferedInputStream inputStream = new BufferedInputStream(
                new FileInputStream(new File("C:\\Users\\Aries\\Desktop\\test_insert.txt")))) {

            BufferedOutputStream outputStream = new BufferedOutputStream(new FileOutputStream(new File("C:\\Users\\Aries\\Desktop\\test_insert_copy.txt")));
...
//            IOUtils.read(inputStream, bytes);
    ...
    public void copyFile() throws IOException {
        long start = System.currentTimeMillis();
        File source = new File("C:\\Users\\Aries\\Desktop\\test_insert.txt");
        File dest = new File("C:\\Users\\Aries\\Desktop\\test_insert_1.txt");
...
//            source.delete();//文件复制完成后，删除源文件
    ...
    public void test3() throws Exception {
        ...
        FileInputStream fis = new FileInputStream("C:\\Users\\Aries\\Desktop\\test_insert.txt");
        FileOutputStream fos = new FileOutputStream("C:\\Users\\Aries\\Desktop\\test_insert_3.txt");
